            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="overview/excel.md">Obtenga más información sobre los componentes de scripts de Office en Excel en la Web: la Grabadora de acciones y el Editor de código.</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introducción</h3>
                        <p><a href="tutorials/excel-tutorial.md">Complete el tutorial para obtener información sobre cómo grabar, editar y crear scripts de Office en Excel en la Web.</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Aspectos básicos de los scripts</h3>
                        <p><a href="develop/scripting-fundamentals.md">Obtenga información sobre los conceptos fundamentales de escribir scripts con los scripts de Office en Excel en la Web.</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <a href="https://support.office.com/article/office-scripts-settings-in-m365-19d3c51a-6ca2-40ab-978d-60fa49554dcf" target="_blank"><h3>Habilitar los scripts de Office</h3></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <a href="/javascript/api/office-scripts/overview" target="_blank"><h3>Scripts de Office<br/>Referencia de la API</h3></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <a href="https://stackoverflow.com/questions/tagged/office-scripts" target="_blank"><h3>Formule preguntas</h3></a>
                    </div>
                </div>
            </div>
        </div>
