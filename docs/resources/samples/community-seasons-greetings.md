---
title: Saludos de temporadas
description: Obtenga información sobre cómo usar scripts de Office para mostrar un árbol de Navidad cantando en Excel en la web.
ms.date: 03/29/2021
...
ms.locfileid: "51571592"
---
# <a name="seasons-greetings"></a><span data-ttu-id="3453f-103">Saludos de temporadas</span><span class="sxs-lookup"><span data-stu-id="3453f-103">Seasons greetings</span></span>

<span data-ttu-id="3453f-104">Este script fue contribuido por [Leslie Black](https://www.linkedin.com/in/lesblackconsultant/) en el ánimo de la temporada de vacaciones.</span><span class="sxs-lookup"><span data-stu-id="3453f-104">This script was contributed by [Leslie Black](https://www.linkedin.com/in/lesblackconsultant/) in the spirit of the holiday season!</span></span> <span data-ttu-id="3453f-105">Es un script divertido que muestra un árbol de Navidad cantando en Excel en la web con scripts de Office.</span><span class="sxs-lookup"><span data-stu-id="3453f-105">It's a fun script that shows a singing Christmas tree in Excel on the web using Office Scripts.</span></span>

<span data-ttu-id="3453f-106">¡Disfrute!</span><span class="sxs-lookup"><span data-stu-id="3453f-106">Enjoy!</span></span>

<span data-ttu-id="3453f-107">[![Ver el script de saludos de Temporadas en acción](../../images/community-seasons.png)](https://youtu.be/HBiGEkzmkgo "¡Scripts de saludos de temporadas en acción!")</span><span class="sxs-lookup"><span data-stu-id="3453f-107">[![Watch the Seasons greetings script in action](../../images/community-seasons.png)](https://youtu.be/HBiGEkzmkgo "Seasons greetings script in action!")</span></span>

## <a name="script"></a><span data-ttu-id="3453f-108">Script</span><span class="sxs-lookup"><span data-stu-id="3453f-108">Script</span></span>
