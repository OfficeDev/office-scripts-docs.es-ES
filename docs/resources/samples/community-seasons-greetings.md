...
---
# <a name="seasons-greetings"></a>Saludos de temporadas

Este script fue contribuido por [Leslie Black](https://www.linkedin.com/in/lesblackconsultant/) en el ánimo de la temporada de vacaciones. Es un script divertido que muestra un árbol de Navidad cantando en Excel en la web con scripts de Office.

¡Disfrute!

[![Ver el script de saludos de Temporadas en acción](../../images/community-seasons.png)](https://youtu.be/HBiGEkzmkgo "¡Scripts de saludos de temporadas en acción!")
