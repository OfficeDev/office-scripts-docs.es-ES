...
### <a name="access"></a><span data-ttu-id="7b72b-108">Acceso</span><span class="sxs-lookup"><span data-stu-id="7b72b-108">Access</span></span>
...
* [<span data-ttu-id="7b72b-124">macOS</span><span class="sxs-lookup"><span data-stu-id="7b72b-124">macOS</span></span>](https://code.visualstudio.com/shortcuts/keyboard-shortcuts-macos.pdf)
...
## <a name="gentle-introduction-to-scripting"></a><span data-ttu-id="7b72b-143">Introducción suave a scripting</span><span class="sxs-lookup"><span data-stu-id="7b72b-143">Gentle introduction to scripting</span></span>
...
<span data-ttu-id="7b72b-158">[![Conceptos básicos de Office scripts](../../images/getting-started-v_script.png)](https://youtu.be/8Zsrc1uaiiU "Conceptos básicos de scripts")</span><span class="sxs-lookup"><span data-stu-id="7b72b-158">[![Basics of Office Scripts](../../images/getting-started-v_script.png)](https://youtu.be/8Zsrc1uaiiU "Basics of Scripts")</span></span>
...
<span data-ttu-id="7b72b-181">Por lo tanto, en resumen:</span><span class="sxs-lookup"><span data-stu-id="7b72b-181">So, in summary:</span></span>
...
<span data-ttu-id="7b72b-195">Puede usar funciones para organizar y reutilizar código dentro del script.</span><span class="sxs-lookup"><span data-stu-id="7b72b-195">You can use functions to organize and reuse code within your script.</span></span>
...
<span data-ttu-id="7b72b-226">Veamos algunos métodos en el `workbook` objeto.</span><span class="sxs-lookup"><span data-stu-id="7b72b-226">Let's look at a few methods on the `workbook` object.</span></span>
...
<span data-ttu-id="7b72b-235">En este ejemplo:</span><span class="sxs-lookup"><span data-stu-id="7b72b-235">In this example:</span></span>
...
#### <a name="method-chaining"></a><span data-ttu-id="7b72b-250">Encadenamiento de métodos</span><span class="sxs-lookup"><span data-stu-id="7b72b-250">Method chaining</span></span>
...
<span data-ttu-id="7b72b-271">Como alternativa, para eliminar un objeto que puede existir o no, use el siguiente patrón.</span><span class="sxs-lookup"><span data-stu-id="7b72b-271">Alternatively, for deleting an object that may or may not exist, use the following pattern.</span></span>
...
* [<span data-ttu-id="7b72b-282">`for` o `while`</span><span class="sxs-lookup"><span data-stu-id="7b72b-282">`for` or `while`</span></span>](https://developer.mozilla.org/docs/Web/JavaScript/Guide/Loops_and_iteration)
...
<span data-ttu-id="7b72b-290">Ejemplos:</span><span class="sxs-lookup"><span data-stu-id="7b72b-290">Examples:</span></span>
...
<span data-ttu-id="7b72b-306">**_Tipos de idioma nativo_**</span><span class="sxs-lookup"><span data-stu-id="7b72b-306">**_Native language types_**</span></span>
...
### <a name="type-assertion-overriding-the-type"></a><span data-ttu-id="7b72b-315">Aserción de tipo (invalidación del tipo)</span><span class="sxs-lookup"><span data-stu-id="7b72b-315">Type assertion (overriding the type)</span></span>
...
<span data-ttu-id="7b72b-338">Para evitar este problema, declare siempre el tipo de la variable.</span><span class="sxs-lookup"><span data-stu-id="7b72b-338">To get around this issue, always declare the type of the variable.</span></span>
...
## <a name="error-handling"></a><span data-ttu-id="7b72b-353">Control de errores</span><span class="sxs-lookup"><span data-stu-id="7b72b-353">Error handling</span></span>
...
### <a name="check-for-object-existence-before-deletion"></a><span data-ttu-id="7b72b-370">Comprobar la existencia de objetos antes de la eliminación</span><span class="sxs-lookup"><span data-stu-id="7b72b-370">Check for object existence before deletion</span></span>
...
### <a name="when-to-abort-throw-the-script"></a><span data-ttu-id="7b72b-383">Cuándo anular ( `throw` ) el script</span><span class="sxs-lookup"><span data-stu-id="7b72b-383">When to abort (`throw`) the script</span></span>  
...
### <a name="when-to-use-trycatch-throw-exception"></a><span data-ttu-id="7b72b-391">Cuándo usar try.. catch (excepción de lanzamiento)</span><span class="sxs-lookup"><span data-stu-id="7b72b-391">When to use try..catch (throw exception)</span></span>
...
### <a name="avoid-slow-operations-in-the-loop"></a><span data-ttu-id="7b72b-403">Evitar operaciones lentas en el bucle</span><span class="sxs-lookup"><span data-stu-id="7b72b-403">Avoid slow operations in the loop</span></span>
...
<span data-ttu-id="7b72b-409">**Nota:** Si el rango o los datos con los que está trabajando es bastante grande (por ejemplo, >celdas de 100K), es posible que necesite usar técnicas avanzadas como dividir las lecturas y escrituras en varios fragmentos.</span><span class="sxs-lookup"><span data-stu-id="7b72b-409">**Note**: If the range/data you are dealing with is quite large (say >100K cells), you may need to use advanced techniques like breaking up your read/writes into multiple chunks.</span></span> <span data-ttu-id="7b72b-410">El siguiente vídeo es realmente para una configuración de datos de tamaño pequeño y mediano.</span><span class="sxs-lookup"><span data-stu-id="7b72b-410">The following video is really for a small-mid sized data setup.</span></span> <span data-ttu-id="7b72b-411">Para un conjunto de datos de gran tamaño, consulte [escenario de escritura de datos avanzado.](write-large-dataset.md)</span><span class="sxs-lookup"><span data-stu-id="7b72b-411">For a large dataset, refer to [advanced data write scenario](write-large-dataset.md).</span></span>

<span data-ttu-id="7b72b-412">[![Vídeo que proporciona una sugerencia de optimización de lectura y escritura](../../images/getting-started-v_perf.jpg)](https://youtu.be/lsR_GvVW3Pg "Vídeo que muestra la sugerencia de optimización de lectura y escritura")</span><span class="sxs-lookup"><span data-stu-id="7b72b-412">[![Video providing a read-and-write optimization tip](../../images/getting-started-v_perf.jpg)](https://youtu.be/lsR_GvVW3Pg "Video showing read-and-write optimization tip")</span></span>

* <span data-ttu-id="7b72b-413">`console.log` instrucción (vea el ejemplo siguiente)</span><span class="sxs-lookup"><span data-stu-id="7b72b-413">`console.log` statement (see the following example)</span></span>
...
* <span data-ttu-id="7b72b-414">`try {} catch ()` instrucción</span><span class="sxs-lookup"><span data-stu-id="7b72b-414">`try {} catch ()` statement</span></span>

<span data-ttu-id="7b72b-415">Evite bucles de control `for` de excepciones.</span><span class="sxs-lookup"><span data-stu-id="7b72b-415">Avoid exception handling `for` loops.</span></span> <span data-ttu-id="7b72b-416">Bucles tanto interiores como externos.</span><span class="sxs-lookup"><span data-stu-id="7b72b-416">Both inside and outside loops.</span></span>

## <a name="note-to-vba-developers"></a><span data-ttu-id="7b72b-417">Nota para desarrolladores de VBA</span><span class="sxs-lookup"><span data-stu-id="7b72b-417">Note to VBA developers</span></span>

<span data-ttu-id="7b72b-418">El lenguaje TypeScript difiere de VBA tanto sintácticamente como en convenciones de nomenclatura.</span><span class="sxs-lookup"><span data-stu-id="7b72b-418">The TypeScript language differs from VBA both syntactically as well as in naming conventions.</span></span>

<span data-ttu-id="7b72b-419">Consulte los siguientes fragmentos de código equivalentes.</span><span class="sxs-lookup"><span data-stu-id="7b72b-419">Check out the following equivalent snippets.</span></span>
...
<span data-ttu-id="7b72b-420">Algunas cosas que se pueden llamar acerca de TypeScript:</span><span class="sxs-lookup"><span data-stu-id="7b72b-420">A few things to call out about TypeScript:</span></span>

* <span data-ttu-id="7b72b-421">Es posible que observe que todos los métodos necesitan tener paréntesis de apertura y cierre para ejecutarse.</span><span class="sxs-lookup"><span data-stu-id="7b72b-421">You may notice that all methods need to have open-close parentheses to execute.</span></span> <span data-ttu-id="7b72b-422">Los argumentos se pasan de forma idéntica, pero es posible que algunos argumentos sean necesarios para la ejecución (es decir, obligatorios frente a opcionales).</span><span class="sxs-lookup"><span data-stu-id="7b72b-422">Arguments are passed identically but some arguments may be required for execution (that is, required vs optional).</span></span>
* <span data-ttu-id="7b72b-423">La convención de nomenclatura sigue a camelCase en lugar de a la convención de PascalCase.</span><span class="sxs-lookup"><span data-stu-id="7b72b-423">The naming convention follows camelCase instead of PascalCase convention.</span></span>
* <span data-ttu-id="7b72b-424">Los métodos suelen `get` tener `set` o prefijos que indican si está leyendo o escribiendo miembros de objeto.</span><span class="sxs-lookup"><span data-stu-id="7b72b-424">Methods usually have `get` or `set` prefixes indicating whether it is reading or writing object members.</span></span>
* <span data-ttu-id="7b72b-425">Los bloques de código se definen e identifican mediante llaves de cierre abierto: `{` `}` .</span><span class="sxs-lookup"><span data-stu-id="7b72b-425">The code blocks are defined and identified by open-close curly braces: `{` `}`.</span></span> <span data-ttu-id="7b72b-426">Los bloques son necesarios `if` para condiciones, `while` instrucciones, `for` bucles, definiciones de función, etc.</span><span class="sxs-lookup"><span data-stu-id="7b72b-426">Blocks are required for `if` conditions, `while` statements, `for` loops, function definitions, etc.</span></span>
* <span data-ttu-id="7b72b-427">Las funciones pueden llamar a otras funciones e incluso puede definir funciones dentro de una función.</span><span class="sxs-lookup"><span data-stu-id="7b72b-427">Functions can call other functions and you can even define functions within a function.</span></span>

<span data-ttu-id="7b72b-428">En general, TypeScript es un idioma diferente y hay pocas similitudes entre ellos.</span><span class="sxs-lookup"><span data-stu-id="7b72b-428">Overall, TypeScript is a different language and there are few similarities between them.</span></span> <span data-ttu-id="7b72b-429">Sin embargo, la API de scripts Office usan una terminología y una jerarquía de modelos de datos (modelo de objetos) similares a las API de VBA y eso le ayudará a navegar.</span><span class="sxs-lookup"><span data-stu-id="7b72b-429">However, the Office Scripts API themselves use similar terminology and data-model (object model) hierarchy as VBA APIs and that should help you navigate around.</span></span>
